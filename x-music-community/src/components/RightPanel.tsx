          ...
          {user && profile ? (
            <div className="bg-slate-50 rounded-2xl p-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-primary">{profile.nickname || '用户'}</div>
                  <div className="text-sm text-secondary">@{profile.username || 'user'}</div>
                </div>
              </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-4">
              <div className="text-center py-4">
                <div className="text-secondary">加载用户信息...</div>
              </div>
            </div>
          ) : (
            <div className="bg-slate-50 rounded-2xl p-4">
